...
function parse_to_HSLArray(colorValue) {
    if (colorValue.includes("rgb")) {
        ...
        console.warn("your color should be hex, rgb or hsl. otherwise it's displayed as black");
        return [0, 0, 0, 1];
    }
}
export { parse_to_HSLArray };
/*
